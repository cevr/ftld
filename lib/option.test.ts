...
describe('Option', () => {
  ...
  describe('traverse', () => {
    it('should create a Some instance with an array of transformed values when all transformations succeed', () => {
      const values = [1, 2, 3];
      const f = (x: number) => Option.fromPredicate((y: number) => y > 0, x * 2);
  ...
  describe('every', () => {
    it('should return an Ok when all values are Ok', () => {
      const options = [Option.Some<number>(1), Option.Some<number>(2), Option.Some<number>(3)];
  ...
  describe('any', () => {
    ...
    it('should return an Err when all values are Err', () => {
      const results = [Option.None<number>(), Option.None<number>(), Option.None<number>()];
